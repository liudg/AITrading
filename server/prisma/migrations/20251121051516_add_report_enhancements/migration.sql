...
INSERT INTO "new_report_model_performances" ("bestTrade", "buyCount", "createdAt", "dailyReturn", "dailyReturnPct", "id", "keyInsights", "modelId", "positionsCount", "positionsDetail", "reportId", "returnAmount", "returnPct", "sellCount", "strategyAnalysis", "totalValue", "tradesCount", "winRate", "worstTrade") SELECT "bestTrade", "buyCount", "createdAt", "dailyReturn", "dailyReturnPct", "id", "keyInsights", "modelId", "positionsCount", "positionsDetail", "reportId", "returnAmount", "returnPct", "sellCount", "strategyAnalysis", "totalValue", "tradesCount", "winRate", "worstTrade" FROM "report_model_performances";
